...
### step 7. 연도별로 전기가 모두 존재하는 PK의 연도만 출력 ###############################################################
...
df_en_annual1.to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\sample2.xlsx")
# #
#
##################################### 건축물대장 + 에너지사용량 병합 ##########################################################################################################
...
print("# of PK1 : ", hos_00['mgm_bld_pk'].nunique())     # of PK1 :  2875
print('# of data1 : ',len(hos_00))                       # of data1 :  76032

## Before : 시설정보
filename1 = "3.의료기관별상세정보서비스_01_시설정보_202309.csv"
filename2 = "4.의료기관별상세정보서비스_02_세부정보_202309.csv"
filename3 = "5.의료기관별상세정보서비스_03_진료과목정보_202309.csv"
filename4 = "7.의료기관별상세정보서비스_05_의료장비정보_202309.csv"
filename5 = "8.의료기관별상세정보서비스_06_식대가산정보_202309.csv"
filename6 = "9.의료기관별상세정보서비스_07_간호등급정보_202309.csv"
filename7 = "10.의료기관별상세정보서비스_08_특수진료정보_202309.csv"

def hospital_data(filename,hos_00):
    file_path = os.path.join(dir_path,filename)
    hos_01 = pd.read_csv(file_path, encoding='cp949')

    print('Before :',filename)
    print("# of PK1 : ", hos_01['mgm_bld_pk'].nunique())     # of PK1 :  16106
    print('# of data1 : ',len(hos_01))                       # of data1 :  20627
    print(' ')
    ...
    if filename == "5.의료기관별상세정보서비스_03_진료과목정보_202309.csv":
        ...
        hos_01 = pd.merge(hos_01_pivot, subject_counts, on=['암호화요양기호', '요양기관명', 'mgm_bld_pk', 'mgm_upper_bld_pk'], how='left')
    ...
    print("# of PK2 : ", hos_01['mgm_bld_pk'].nunique())     # of PK2 :  1132
    print('# of data2 : ',len(hos_01))                       # of data2 :  1132
    print(' ')
    ...
    if filename == "3.의료기관별상세정보서비스_01_시설정보_202309.csv":
        hos_merge = pd.merge(left=hos_00, right=hos_01, how='inner', on=['암호화요양기호','mgm_bld_pk','종별코드명']) ## 암호화요양기호 및 매칭표제부 2개 기준 병합
    else:
    ...
    print("# of PK3 : ", hos_merge['mgm_bld_pk'].nunique())     # of PK3 :  1030
    print('# of data3 : ',len(hos_merge))                       # of data3 :  1030
    print(' ')
...
hos1=hospital_data(filename1,hos_00)
hos2=hospital_data(filename2,hos_00)
hos3=hospital_data(filename3,hos_00)
hos4=hospital_data(filename4,hos_00)
hos5=hospital_data(filename5,hos_00)
hos6=hospital_data(filename6,hos_00)
hos7=hospital_data(filename7,hos_00)

merge_columns = ['암호화요양기호','mgm_bld_pk',]
merged_df = hos1.merge(hos2, on=merge_columns).merge(hos3, on=merge_columns).merge(hos4, on=merge_columns).merge(hos5, on=merge_columns).merge(hos6, on=merge_columns)

hos_merge1 = pd.merge(left=df_combined1, right=merged_df, how='inner',left_on=['매칭표제부PK'], right_on=['mgm_bld_pk'])
...
hospital_2018=count_dataset(hos_merge1,2018)
hospital_2019=count_dataset(hos_merge1,2019)
hospital_2020=count_dataset(hos_merge1,2020)
hospital_2021=count_dataset(hos_merge1,2021)
hospital_2022=count_dataset(hos_merge1,2022)
hospital_2018.to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\데이터넷_2018..xlsx")


# 간호등급정보_2018=count_dataset(hos7,2018)
# 간호등급정보_2019=count_dataset(hos7,2019)
# 간호등급정보_2020=count_dataset(hos7,2020)
# 간호등급정보_2021=count_dataset(hos7,2021)
# 간호등급정보_2022=count_dataset(hos7,2022)
...
# if filename == "3.의료기관별상세정보서비스_01_시설정보_202309.csv":
#     count_dataset(hos_merge1, 2018).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2018\데이터넷_1_2018_01_시설정보.xlsx")
#     count_dataset(hos_merge1, 2019).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2019\데이터넷_1_2019_01_시설정보.xlsx")
#     count_dataset(hos_merge1, 2020).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2020\데이터넷_1_2020_01_시설정보.xlsx")
#     count_dataset(hos_merge1, 2021).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2021\데이터넷_1_2021_01_시설정보.xlsx")
#     count_dataset(hos_merge1, 2022).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2022\데이터넷_1_2022_01_시설정보.xlsx")
#
# if filename == "4.의료기관별상세정보서비스_02_세부정보_202309.csv":
#     count_dataset(hos_merge1, 2018).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2018\데이터넷_1_2018_02_세부정보.xlsx")
#     count_dataset(hos_merge1, 2019).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2019\데이터넷_1_2019_02_세부정보.xlsx")
#     count_dataset(hos_merge1, 2020).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2020\데이터넷_1_2020_02_세부정보.xlsx")
#     count_dataset(hos_merge1, 2021).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2021\데이터넷_1_2021_02_세부정보.xlsx")
#     count_dataset(hos_merge1, 2022).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2022\데이터넷_1_2022_02_세부정보.xlsx")
#
# if filename == "5.의료기관별상세정보서비스_03_진료과목정보_202309.csv":
#     count_dataset(hos_merge1, 2018).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2018\데이터넷_1_2018_03_진료과목정보.xlsx")
#     count_dataset(hos_merge1, 2019).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2019\데이터넷_1_2019_03_진료과목정보.xlsx")
#     count_dataset(hos_merge1, 2020).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2020\데이터넷_1_2020_03_진료과목정보.xlsx")
#     count_dataset(hos_merge1, 2021).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2021\데이터넷_1_2021_03_진료과목정보.xlsx")
#     count_dataset(hos_merge1, 2022).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2022\데이터넷_1_2022_03_진료과목정보.xlsx")
# if filename == "7.의료기관별상세정보서비스_05_의료장비정보_202309.csv":
#     count_dataset(hos_merge1, 2018).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2018\데이터넷_1_2018_05_의료장비정보.xlsx")
#     count_dataset(hos_merge1, 2019).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2019\데이터넷_1_2019_05_의료장비정보.xlsx")
#     count_dataset(hos_merge1, 2020).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2020\데이터넷_1_2020_05_의료장비정보.xlsx")
#     count_dataset(hos_merge1, 2021).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2021\데이터넷_1_2021_05_의료장비정보.xlsx")
#     count_dataset(hos_merge1, 2022).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2022\데이터넷_1_2022_05_의료장비정보.xlsx")
# if filename == "8.의료기관별상세정보서비스_06_식대가산정보_202309.csv":
#     count_dataset(hos_merge1, 2018).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2018\데이터넷_1_2018_06_식대가산정보.xlsx")
#     count_dataset(hos_merge1, 2019).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2019\데이터넷_1_2019_06_식대가산정보.xlsx")
#     count_dataset(hos_merge1, 2020).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2020\데이터넷_1_2020_06_식대가산정보.xlsx")
#     count_dataset(hos_merge1, 2021).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2021\데이터넷_1_2021_06_식대가산정보.xlsx")
#     count_dataset(hos_merge1, 2022).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2022\데이터넷_1_2022_06_식대가산정보.xlsx")
# if filename == "9.의료기관별상세정보서비스_07_간호등급정보_202309.csv":
#     count_dataset(hos_merge1, 2018).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2018\데이터넷_1_2018_07_간호등급정보.xlsx")
#     count_dataset(hos_merge1, 2019).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2019\데이터넷_1_2019_07_간호등급정보.xlsx")
#     count_dataset(hos_merge1, 2020).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2020\데이터넷_1_2020_07_간호등급정보.xlsx")
#     count_dataset(hos_merge1, 2021).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2021\데이터넷_1_2021_07_간호등급정보.xlsx")
#     count_dataset(hos_merge1, 2022).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2022\데이터넷_1_2022_07_간호등급정보.xlsx")
# if filename == "10.의료기관별상세정보서비스_08_특수진료정보_202309.csv":
#     count_dataset(hos_merge1, 2018).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2018\데이터넷_1_2018_08_특수진료정보.xlsx")
#     count_dataset(hos_merge1, 2019).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2019\데이터넷_1_2019_08_특수진료정보.xlsx")
#     count_dataset(hos_merge1, 2020).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2020\데이터넷_1_2020_08_특수진료정보.xlsx")
#     count_dataset(hos_merge1, 2021).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2021\데이터넷_1_2021_08_특수진료정보.xlsx")
#     count_dataset(hos_merge1, 2022).to_excel(r"C:\Users\user\Desktop\데이터넷_의료시설(건축물대장,에너지사용량)\2022\데이터넷_1_2022_08_특수진료정보.xlsx")
