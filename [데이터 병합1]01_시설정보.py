...
file1 = pd.read_csv(r"C:\Users\user\OneDrive - Ajou University\학부연구생 발표\데이터넷 과제\건강보험심사평가원_전국 병의원 및 약국 현황-PK연결\3.의료기관별상세정보서비스_01_시설정보_202309.csv", encoding='EUC-KR', dtype=str)
...
tmerged_data2018.to_excel(r'C:\Users\user\OneDrive - Ajou University\학부연구생 발표\데이터넷 과제\[데이터 병합]01_시설정보.xlsx', index=False)
...
def graph(data, energy_type, unit):
    ...
    plt.xlabel('총의사수/용적률산정연면적(인/㎡)', fontsize=20)
    ...
    # 그래프 저장
    plt.savefig(f'C:/Users/user/OneDrive - Ajou University/학부연구생 발표/데이터넷 과제/시설정보_{energy_type}.tiff', format='tiff', dpi=300)
    plt.show()
